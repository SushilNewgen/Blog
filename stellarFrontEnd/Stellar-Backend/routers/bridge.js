  ...
  */
  ...
  getPayments: (req, res, next) => {
    ...
    .then( payments => {
      ...
      _.set(req, ['body', 'payments'], _.get(payments, ['rows'], []));
      return next();
  ...
  updatePayments: (req, res, next) => {
    ...
    let schema                    = _.get(SCHEMA, 'updatePayments', {});
    ...
    DB.updatePayments( body )
    .then( updateResult => {

      logger.info("DB insertion response: ", updateResult);
      _.set(req, ['body', 'updateResult'], updateResult);
      return next();

    })
    .catch( err => {

      _.set(req, ['body', 'updateResult'], false);
      return next();
